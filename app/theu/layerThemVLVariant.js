...
export default function LayerThemVL(props) {
    ...
    function changeThongtinLop(name, value, keyVariant) {
        ...
        if (name == "chatLieu" && value == "custom") {
            ...
            let item = props.item;
            item[name] = value
            props.changeLopCL(item, props.stt, keyVariant);
    ...
    function setChatLieuNgoai(item) {
        ...
        if (name != undefined)
            changeThongtinLop("chatLieu", "custom" + name, props.keyVariant)
                    ...
                    <div>{/* vật liệu */}
                        <FormControl sx={{ m: 1, minWidth: 120 }} size="small">
                            ...
                            <Select
                                ...
                                onChange={(e) => changeThongtinLop("chatLieu", e.target.value, props.keyVariant)} value={((props.item.chatLieu?.startsWith("custom")) ? "custom" : props.item.chatLieu)}
                                label="Chất Liệu"
                            >
                                ...
                                <MenuItem value="go6mm">Gỗ 5mm</MenuItem>
                    ...
                    <div className="kvsvlsvlffs">
                        <Box component="form" sx={{ '& > :not(style)': { m: 1, width: '20ch' } }} noValidate autoComplete="off">
                            <TextField id="outlined-basic" label="Chiều ngang" variant="outlined" type="number" size="small"
                                ...
                                onChange={(e) => changeThongtinLop("chieuDai", _.toNumber(e.target.value), props.keyVariant)}
                                placeholder="Nhập số"
                    ...
                    <div className="kvsvlsvlffs">
                        <Box component="form" sx={{ '& > :not(style)': { m: 1, width: '20ch' } }} noValidate autoComplete="off">
                            <TextField id="outlined-basic" label="Chiều dọc" variant="outlined" type="number" size="small"
                                ...
                                onChange={(e) => changeThongtinLop("chieuRong", _.toNumber(e.target.value), props.keyVariant)}
                                placeholder="Nhập số"
                                slotProps={{ input: { endAdornment: <InputAdornment position="end">inch</InputAdornment>, }, }}
                            />
                        </Box>
                    ...
                    <div>{/* vật liệu */}
                        <FormControl sx={{ m: 1, minWidth: 100 }} size="small">
                            ...
                            <Select
                                labelId="demo-simple-select-standard-label"
                                id="demo-simple-select-standard"
                                onChange={(e) => changeThongtinLop("soMatIn", e.target.value, props.keyVariant)}
                    ...
                    <div>
                        <FormControl sx={{ m: 1, minWidth: 100 }} size="small">
                            ...
                            <Select
                                ...
                                onChange={(e) => changeThongtinLop("catStatus", e.target.value, props.keyVariant)}
                                label="Cut Laze"
                            >
                    ...
                    <div>
                        <FormControl sx={{ m: 1, minWidth: 100 }} size="small">
                            ...
                            <Select
                                ...
                                onChange={(e) => changeThongtinLop("khacStatus", e.target.value, props.keyVariant)}
                                label="Khắc"
                            >
                                <MenuItem value={true}>có</MenuItem>
                                <MenuItem value={false}>không</MenuItem>
